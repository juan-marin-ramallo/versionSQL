/****** Object:  Procedure [dbo].[GetProductsFilteredNoImages]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[GetProductsFilteredNoImages]
...
SET NOCOUNT ON;
	...
	SELECT P.[Id], P.[Name], P.[Identifier], P.[BarCode], PC.[Id] AS ProductCategoryId, PC.[Name] AS ProductCategoryName, P.[Indispensable],
		PC.[Id] AS ProductCategoryId, PC.[Name] AS ProductCategoryName, PC.[Order] AS ProductCategoryOrder,
	...
	GROUP BY P.[Id], P.[Name], P.[Identifier], P.[BarCode], P.[Indispensable], PC.[Id] , PC.[Name], PC.[Order], b.[Id], b.[Name], PCL.[Id],
	CM.[Identifier], CM.[Name], CM.[Id], b.[Identifier],
	P.[MinSalesQuantity], P.[MinUnitsPackage], P.[MaxSalesQuantity], P.[InStock],
	P.[Column_1], P.[Column_2], P.[Column_3], P.[Column_4],
	P.[Column_5], P.[Column_6], P.[Column_7], P.[Column_8], P.[Column_9],
	P.[Column_10], P.[Column_11], P.[Column_12], P.[Column_13], P.[Column_14], P.[Column_15], P.[Column_16], P.[Column_17],
	P.[Column_18], P.[Column_19], P.[Column_20], P.[Column_21], P.[Column_22], P.[Column_23], P.[Column_24],
	P.[Column_25], P.[TheoricalPrice]
