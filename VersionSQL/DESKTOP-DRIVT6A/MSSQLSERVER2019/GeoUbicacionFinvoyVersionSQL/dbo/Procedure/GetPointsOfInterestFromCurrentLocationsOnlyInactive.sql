/****** Object:  Procedure [dbo].[GetPointsOfInterestFromCurrentLocationsOnlyInactive]    Committed by VersionSQL https://www.versionsql.com ******/

-- =============================================
-- Author:		Diego Caceres
-- Create date: 24/08/2016
-- Description:	SP para obtener los datos de los puntos de interés cercanos a las posiciones actuales INACTIVAS
-- =============================================
CREATE PROCEDURE [dbo].[GetPointsOfInterestFromCurrentLocationsOnlyInactive]
(
...
BEGIN
	...
	WHERE		Tzdb.AreSameSystemDates(CL.Date, GETUTCDATE()) = 0
