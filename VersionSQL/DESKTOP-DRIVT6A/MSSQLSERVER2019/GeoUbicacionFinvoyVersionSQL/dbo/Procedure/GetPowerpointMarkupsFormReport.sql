/****** Object:  Procedure [dbo].[GetPowerpointMarkupsFormReport]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
CREATE PROCEDURE [dbo].[GetPowerpointMarkupsFormReport]	
	 @IdForm [sys].[int]
AS
BEGIN
