/****** Object:  Procedure [dbo].[GetPersonOfInterestRouteTheoricalMinutes]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
CREATE PROCEDURE [dbo].[GetPersonOfInterestRouteTheoricalMinutes]
(
...
BEGIN
    ...
    ORDER BY	S.[Name], S.[LastName], P.[Name]
END
