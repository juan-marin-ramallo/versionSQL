/****** Object:  Procedure [dbo].[GetFormsZonesImages]    Committed by VersionSQL https://www.versionsql.com ******/

-- =============================================
-- Author:		Jesús Portillo
-- Create date: 05/05/2021
-- Description:	SP para obtener la cantidad de imágenes de tareas por agrupación
-- =============================================
CREATE PROCEDURE [dbo].[GetFormsZonesImages]
...
BEGIN
	...
	SELECT  SZ.[IdZone], SZ.[ZoneDescription], COUNT(DISTINCT AI.[Id]) ImagesCount
	...
	GROUP BY	SZ.[IdZone], SZ.[ZoneDescription]
	ORDER BY	SZ.[ZoneDescription]
