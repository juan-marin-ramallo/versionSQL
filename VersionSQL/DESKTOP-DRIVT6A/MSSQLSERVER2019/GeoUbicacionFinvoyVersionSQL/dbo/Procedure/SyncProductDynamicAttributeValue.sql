/****** Object:  Procedure [dbo].[SyncProductDynamicAttributeValue]    Committed by VersionSQL https://www.versionsql.com ******/

-- =============================================
-- Author:		GL
-- Create date: 24&11
-- Description:	USADO PARA ACTUALIZAR ATRIBUTOS DINAMICOS DE PRODUCTOS EN IMPORTACION MASIVA
-- =============================================
CREATE PROCEDURE [dbo].[SyncProductDynamicAttributeValue]
...
BEGIN
	...
	WHERE	[Identifier] = @ProductIdentifier AND [Deleted] = 0
