/****** Object:  Procedure [dbo].[GetCatalogsFilteredWithProducts]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================  
CREATE PROCEDURE [dbo].[GetCatalogsFilteredWithProducts]   
  @CatalogIds VARCHAR(MAX) = NULL    
...
BEGIN  
    ...
    SELECT  C.[Id], C.[Name],   
   P.[Id] AS ProductId, P.[Name] AS ProductName, P.[BarCode] AS ProductBarCode, P.[Identifier] AS ProductIdentifier, P.[Deleted] AS ProductDeleted  
 FROM [dbo].[Catalog] C  
 ...
 WHERE C.[Deleted] = 0  AND (@WithProducts = 1 OR P.Deleted = 0) AND    
