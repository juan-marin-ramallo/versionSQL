/****** Object:  Procedure [dbo].[GetCurrentLocationsOnlyInactive]    Committed by VersionSQL https://www.versionsql.com ******/

-- =============================================
-- Author:		Diego Caceres
-- Create date: 24/08/20166
-- Description:	SP para obtener las ubicaciones actuales de los repositores solo INACTIVOS
-- =============================================
CREATE PROCEDURE [dbo].[GetCurrentLocationsOnlyInactive]
(
...
-- 			((@IdUser IS NULL) OR (dbo.CheckDepartmentInUserDepartments(S.[IdDepartment], @IdUser) = 1)) AND
-- 			((@IdUser IS NULL) OR (dbo.CheckUserInPersonOfInterestZones(S.[Id], @IdUser) = 1))
-- 			AND Tzdb.AreSameSystemDates(CL.Date, GETUTCDATE()) = 0
