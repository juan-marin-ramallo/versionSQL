/****** Object:  Procedure [dbo].[GetCompletedImageAnswersInfo]    Committed by VersionSQL https://www.versionsql.com ******/

-- =============================================
-- Author:		JP
-- Create date: 08/03/2021
-- Description:	SP para obtener algunos datos de las respuestas a fotos de tareas.
-- =============================================
CREATE PROCEDURE [dbo].[GetCompletedImageAnswersInfo]
	@IdForm [sys].[int],
