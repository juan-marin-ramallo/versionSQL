/****** Object:  Procedure [dbo].[GetPointsOfInterestFromCurrentLocations]    Committed by VersionSQL https://www.versionsql.com ******/

-- =============================================
-- Author:		Federico Sobral
-- Create date: 29/11/2013
-- Description:	SP para obtener los datos de los puntos de interés cercanos a las posiciones actuales
-- =============================================
CREATE PROCEDURE [dbo].[GetPointsOfInterestFromCurrentLocations]
(
...
BEGIN
	...
	SELECT		P.[Id], P.[Name], P.[Address], P.[Latitude], P.[Longitude], P.[Radius], P.[MinElapsedTimeForVisit], P.[IdDepartment], P.[Identifier]
